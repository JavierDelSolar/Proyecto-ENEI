...
$(document).ready(function(){
	var tbl = Make_DataTable("#tbl", "user/ListarEmpleados", null, columna);
	
	$("#tbl").on("click","button.button-edit",function(){
        var data = {};
        data["usuario"] = $(this).attr("usuario");
        data = JSON.stringify(data);
        RequestAjaxJson("user/getEmpleado", "POST", data, function(){
        }, function(result){
    ...
    $("button[option='crear']").click(function(){
		...
		data = JSON.stringify(data);
		RequestAjaxJson("user/crearEmpleado", "POST", data, function(){
        }, function(result){
            tbl.ajax.reload();
        });
	});
	...
	$("button[option='guardar']").click(function(){
		...
		data["correo"] = $("#correo").val();
		data = JSON.stringify(data);
		RequestAjaxJson("user/updateEmpleado", "POST", data, function(){
        }, function(result){
            tbl.ajax.reload();
        });
	});
	...
	$("button[option='eliminar']").click(function(){
		...
		data["usuario"] = $("#usuario").val();
		data = JSON.stringify(data);
		RequestAjaxJson("user/deleteEmpleado", "POST", data, function(){
        }, function(result){
            tbl.ajax.reload();
        });
	});
